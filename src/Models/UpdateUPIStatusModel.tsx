...
const UpdateUPIStatusModel: React.FC<BankDetailsModalProps> = ({
  isOpen,
  onClose,
  selectedData,
  onSuccess,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateUpitStatus(token, { id, status, remark });
...
export default UpdateUPIStatusModel;
